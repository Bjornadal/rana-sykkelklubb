...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Weekly training activities for Rana Sykkelklubb';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Inne', 'Ute']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'News articles for Rana Sykkelklubb';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Events and arrangements for Rana Sykkelklubb';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
